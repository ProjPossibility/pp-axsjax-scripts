...
function axsJb_keyboardHandler(evt){
	...
	{
	axsWiki.axsObj.speakText(axsWiki.helpString);
	}
...
paragraphReader.traverseLinks = function() {
  ...
  if (links == 0) {
	axsWiki.axsObj.speakText("There are no links in this paragraph. ");
	return;
  }
  ...
  axsWiki.axsObj.speakText(message);
};
