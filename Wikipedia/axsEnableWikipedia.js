...
function axsJb_keyboardHandler(evt){
	...
	{
	axsWiki.axsObj.speakThroughTextNode(axsWiki.helpString);
	}
...
paragraphReader.countLinksAndCitations = function() {
  ...
  axsWiki.axsObj.speakThroughTextNode(str);
};
...
paragraphReader.traverseLinks = function() {
  ...
  if (links == 0) {
	axsWiki.axsObj.speakThroughTextNode("There are no links in this paragraph. ");
	return;
  }
  ...
  axsWiki.axsObj.speakThroughTextNode(message);
};
